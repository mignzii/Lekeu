  ...
  return (
    <div className=" bg-onboarding  bg-contain bg-no-repeat py-4 h-full px-4 ">
        <div className=' mx-auto max-w-screen-lg container space-y-3 mt-8 bg-white rounded-md'>
              ...
              <p className='text-base leading-8 md:font-medium font-semibold text-center w-[750px]'> Découvrez comment faciliter l'intégration de votre restaurant sur la plateforme Leek grâce
              ...
              <div className='flex justify-between w-full max-w-screen-lg gap-x-4  mx-auto'>
                  <div className='flex flex-col gap-y-2 justify-center items-center'>
                    ...
                    <p className='md:font-medium font-semibold'>Créer un Compte</p>
                    <p className='text-sm leading-5 hidden md:block'> Commencez par créer un compte en fournissant
                       les informations de base de votre restaurant,
                        telles que le nom, l'adresse et les coordonnées de contact.</p>
                  </div>
                  <div className='flex flex-col gap-y-2 justify-center items-center'>
                    <p className='font-bold '>Step 2</p>
                    <p className='md:font-medium font-semibold'> Configuration du profil</p>
                    <p className='text-sm leading-5 text-justify hidden md:block'> Commencez par créer un compte en fournissant
                       les informations de base de votre restaurant,
                        telles que le nom, l'adresse et les coordonnées de contact.</p>
                  </div>
                  <div className='flex flex-col gap-y-2 justify-center items-center'>
                    <p className='font-bold '>Step 3</p>
                    <p className='md:font-medium font-semibold'>   Exploration de la Plateforme </p>
                    <p className='text-sm leading-5 hidden md:block'> Commencez par créer un compte en fournissant
                       les informations de base de votre restaurant,
                        telles que le nom, l'adresse et les coordonnées de contact.</p>
                  </div>
